...
const EmployerRegistration = () => {
  ...
  const onSubmit = (data) => {
    ...
    console.log("employer forms data on submit ", employer);
  ...
  return (
    <div className=" min-h-screen">
      ...
      >
        <Link to={"/role"}>
          <div className="duration-500  absolute -top-9 -left-9 bg-gray-600 text-white hover:text-gray-600  shadow-xl rounded-tr-[35px] rounded-bl-[35px] p-6 hover:bg-gray-300 transform hover:-translate-y-1 hover:scale-105 transition-all  px-10">
