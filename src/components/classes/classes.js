...
export const homeButton =
  "duration-500 bg-primary py-3 px-6 rounded-full text-accent font-bold shadow-md uppercase tracking-wider hover:bg-warning"; // Apply short list and details button
